...
public class SettingDao {
    ...
    public static void setUser(String username, String name, String secondName, String email, int id ) {
        Statement stm = null;
        try {
    ...
    public static void setClub(String username, String city, String address, String email, int id) {
